...
Proyecto derivado de la tesis de Ricardo Jara Gaspar (Universidad Nacional Mayor de San
Marcos), reorganizado como caso de estudio para
[FuzzyFrog.AI — ATLAS AI Thesis Lab](https://fuzzyfrog.ai/es/ai-lab/proyectos/salud/clasificacion-displasia-cadera-resnet50-gan/).
...
Notebook original: Ricardo Jara Gaspar. Adaptación como caso de estudio: [Alan López — FuzzyFrog.AI](https://fuzzyfrog.ai/es/#about-temporary).
